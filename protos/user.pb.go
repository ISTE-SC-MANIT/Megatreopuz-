...
var file_user_proto_depIdxs = []int32{
	...
	3, // 2: protos.UserService.getPlayer:input_type -> protos.Empty
	3, // 3: protos.UserService.createLocalPlayer:output_type -> protos.Empty
	3, // 4: protos.UserService.updateLocalPlayer:output_type -> protos.Empty
	2, // 5: protos.UserService.getPlayer:output_type -> protos.getPlayerResponse
